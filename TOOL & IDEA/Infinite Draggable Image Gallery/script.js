// Initialize Tweakpane if available
let Pane;
try {
  // Try to load Tweakpane from CDN
  Pane = window.Pane || null;
} catch (e) {
  console.warn("Tweakpane not available, some controls will be disabled");
  Pane = null;
}
...
const imageUrls = [
  ...
  "https://source.unsplash.com/random/800x650?city",
  "https://source.unsplash.com/random/800x700?technology", 
  "https://source.unsplash.com/random/800x550?people",
  "https://source.unsplash.com/random/800x750?architecture",
  "https://source.unsplash.com/random/800x600?animals",
  "https://source.unsplash.com/random/800x650?travel"
];
...
function initTweakpane() {
  ...
  if (!window.Tweakpane) {
    console.warn("Tweakpane not available, skipping initialization");
    return;
  }
